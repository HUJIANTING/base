      ...
      <div class="content-box">
        ...
        <el-form ref="loginForm" :model="loginForm" :rules="loginRules">
          ...
          <!-- <el-form-item prop="phone">
            <div class="password">
              <el-input v-model="loginForm.phone" placeholder="请输入手机号" :maxlength="11" /><img class="left-icon" src="../../../static/login/login_i_username@2x.png" alt="">
            </div>
          </el-form-item> -->
          <el-form-item prop="code" class="input-code">
            <div class="codeBox">
              ...
              <!-- <el-button class="code" :disabled="disabledBtn" @click="getVerifyCode">{{ btnTitle }}</el-button> -->
            </div>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    // 判断输入的手机号是否合法
    validatePhone() {
      const req = /^1[345678]\d{9}$/
      if (!this.loginForm.phone) {
        // this.$message.error('手机号码不能为空!')
        return
      } else if (!req.test(this.loginForm.phone)) {
    ...
    // 发送验证码接口
    getCodeRequest() {
      // getCreditPromiseList(this.searchFrom).then(({ code, data, msg }) => {
      //   if (code === 1) {
      //     this.tableList = data
